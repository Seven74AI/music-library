...
const isBuffer = (obj: unknown): obj is Buffer => Buffer.isBuffer(obj) || obj instanceof Uint8Array;
...
const getStatement = cacheDb.prepare("SELECT value, metadata FROM cache WHERE key = ?");
