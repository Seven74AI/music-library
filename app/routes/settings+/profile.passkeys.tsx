...
export default function Passkeys({ loaderData }: Route.ComponentProps) {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      {error ? (
        <div className="bg-destructive/15 text-destructive rounded-lg p-4">{error}</div>
      ) : null}
      ...
      {loaderData.passkeys.length ? (
        ...
        <div className="text-muted-foreground text-center">No passkeys registered yet</div>
      )}
    </div>
  );
}
