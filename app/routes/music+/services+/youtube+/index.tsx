    ...
    switch (intent) {
      case "sync": {
        ...
        if (hasValidOAuth) {
          ...
          return data(
            { status: "error", message: "Please connect your YouTube account first." },
            { status: 401 },
          );
        }
      }
    ...
    <div className="py-8">
      ...
      <Card className="mb-6">
        <CardHeader>
          ...
          <CardDescription>Your YouTube account connection and sync status</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div
                className={`w-3 h-3 rounded-full ${hasConnection ? "bg-green-500" : "bg-red-500"}`}
              />
      ...
      {hasConnection && syncedPlaylists.length > 0 && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>Your synchronized YouTube playlists (showing first 5)</CardDescription>
          </CardHeader>
          <CardContent>
