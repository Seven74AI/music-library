...
export type YouTubePlaylistDiscoveryIntent =
  (typeof YOUTUBE_PLAYLIST_DISCOVERY_INTENTS)[keyof typeof YOUTUBE_PLAYLIST_DISCOVERY_INTENTS];
...
export type YouTubePlaylistDetailIntent =
  (typeof YOUTUBE_PLAYLIST_DETAIL_INTENTS)[keyof typeof YOUTUBE_PLAYLIST_DETAIL_INTENTS];
...
export type YouTubeSyncedPlaylistsIntent =
  (typeof YOUTUBE_SYNCED_PLAYLISTS_INTENTS)[keyof typeof YOUTUBE_SYNCED_PLAYLISTS_INTENTS];
...
export type YouTubeImportIntent =
  (typeof YOUTUBE_IMPORT_INTENTS)[keyof typeof YOUTUBE_IMPORT_INTENTS];
 ...
 */
export function validatePlaylistDiscoveryIntent(
  intent: unknown,
): intent is YouTubePlaylistDiscoveryIntent {
  return (
    typeof intent === "string" &&
    (Object.values(YOUTUBE_PLAYLIST_DISCOVERY_INTENTS) as readonly string[]).includes(intent)
  );
}

export function validatePlaylistDetailIntent(
  intent: unknown,
): intent is YouTubePlaylistDetailIntent {
  return (
    typeof intent === "string" &&
    (Object.values(YOUTUBE_PLAYLIST_DETAIL_INTENTS) as readonly string[]).includes(intent)
  );
}

export function validateSyncedPlaylistsIntent(
  intent: unknown,
): intent is YouTubeSyncedPlaylistsIntent {
  return (
    typeof intent === "string" &&
    (Object.values(YOUTUBE_SYNCED_PLAYLISTS_INTENTS) as readonly string[]).includes(intent)
  );
}
...
export function validateImportIntent(intent: unknown): intent is YouTubeImportIntent {
  return (
    typeof intent === "string" &&
    (Object.values(YOUTUBE_IMPORT_INTENTS) as readonly string[]).includes(intent)
  );
}
